                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-12">
                        <div className="bg-[#E7E7E7] dark:bg-[#2E2640] rounded-3xl p-6 md:p-12">
                            ...
                            <div className="space-y-6">
                                    ...
                                    La marketplace<br />
                                    <span className="text-[#FF7961] dark:text-[#FF7961]">des ressourceries</span><br />
                                    françaises
                                </h1>
                                    <p className="text-base md:text-lg">
                                    Donner une seconde vie aux produits dénichés, ça vaut le coût ! Pivot, est 
                                    la première plateforme de <span className="text-[#6ED47C] dark:text-[#6ED47C] font-medium">click-and-collect</span> dédiée aux ressourceries en 
                                    France !
                                </p>
                                ...
                                <div className="flex w-full max-w-md bg-white dark:bg-[#1C1929] rounded-lg overflow-hidden border border-gray-300 dark:border-gray-700">
                                    ...
                                    <div className="px-3 py-3 border-l border-gray-300 dark:border-gray-700 hidden sm:flex items-center">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1 dark:text-white" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-12">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                            <div>
                                ...
                                <p className="text-[#6ED47C] dark:text-[#6ED47C] mt-2">Retrouvez toutes les annonces des ressourceries près de chez vous !</p>
                            </div>
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-12">
                        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                            ...
                            <div className="w-full lg:w-1/4">
                                <h2 className="text-3xl font-bold dark:text-white">Nos coups<br />de coeur</h2>
                                <p className="text-gray-700 dark:text-gray-300 mt-2">
                                    Allongez la durée de vie des objets tout en faisant croître de nouvelles interactions !
                                </p>
                                
                                <Link href="/catalogue" className="inline-flex items-center mt-4 px-5 py-2 bg-black dark:bg-white text-white dark:text-black rounded">
                                    voir le catalogue
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2" viewBox="0 0 20 20" fill="currentColor">
                                        <path fillRule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                                    </svg>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
                                    ...
                                    <div className="bg-white dark:bg-[#1C1929] rounded-lg overflow-hidden border border-gray-100 dark:border-gray-700">
                                        ...
                                        <div className="p-3">
                                            <div className="text-xs text-gray-500 dark:text-gray-400">Ressourcerie des biscottes (49)</div>
                                            <div className="uppercase text-xs font-semibold text-[#6ED47C] dark:text-[#6ED47C] mt-1">ART DE LA TABLE</div>
                                            <h3 className="font-semibold text-gray-900 dark:text-white mt-1">5 astuces pour une déco éco-responsable</h3>
                                    ...
                                    <div className="bg-white dark:bg-[#1C1929] rounded-lg overflow-hidden border border-gray-100 dark:border-gray-700">
                                        ...
                                        <div className="p-3">
                                            <div className="text-xs text-gray-500 dark:text-gray-400">Ressourcerie des biscottes (49)</div>
                                            <div className="uppercase text-xs font-semibold text-[#6ED47C] dark:text-[#6ED47C] mt-1">ART DE LA TABLE</div>
                                            <h3 className="font-semibold text-gray-900 dark:text-white mt-1">Les pièces vintage qui prennent de la valeur</h3>
                ...
                <section className="py-12">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-12">
                        <div className="flex items-center justify-between mb-12">
                            ...
                            <Link href="/dénicher" className="px-4 py-2 bg-[#13111A] dark:bg-white text-white dark:text-[#13111A] rounded flex items-center">
                                dénicher
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2" viewBox="0 0 20 20" fill="currentColor">
                                    <path fillRule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                                </svg>
                    ...
                    <div className="container mx-auto px-12">
                        <div className="flex items-center justify-between mb-8">
                            <div>
                                ...
                                <p className="text-[#6ED47C] dark:text-[#6ED47C] mt-1">insertion professionnelles, idées déco, témoignages, arrivages, Pivot aide les ressourceries à communiquer.</p>
                            </div>
                            <Link href="/actualites" className="px-4 py-2 bg-[#13111A] dark:bg-white text-white dark:text-[#13111A] rounded flex items-center">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white dark:bg-[#1C1929] rounded-lg overflow-hidden col-span-1 md:col-span-2 lg:col-span-1">
                                ...
                                <div className="p-6">
                                    ...
                                    <h3 className="font-semibold text-gray-900 dark:text-white mt-2 text-lg">Comment meubler son intérieur avec du seconde main ?</h3>
                                    <Link href="/articles/meubler-seconde-main" className="text-[#6ED47C] dark:text-[#6ED47C] text-sm font-medium flex items-center mt-4">
                                        LIRE L'ARTICLE
                            ...
                            <div className="bg-white dark:bg-[#1C1929] rounded-lg overflow-hidden col-span-1 md:col-span-2 lg:col-span-1">
                                ...
                                <div className="p-6">
                                    <div className="text-sm text-gray-500 dark:text-gray-400">24/09/2024</div>
                                    <h3 className="font-semibold text-gray-900 dark:text-white mt-2 text-lg">Focus ressourcerie : Rencontre avec des passionnés du réemploi</h3>
                                    <Link href="/articles/focus-ressourcerie" className="text-[#6ED47C] dark:text-[#6ED47C] text-sm font-medium flex items-center mt-4">
                                        LIRE L'ARTICLE
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" viewBox="0 0 20 20" fill="currentColor">
                                            <path fillRule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                                        </svg>
                            ...
                            <div className="col-span-1 md:col-span-2 lg:col-span-1 space-y-4">
                                ...
                                <div className="bg-white dark:bg-[#1C1929] rounded-lg p-4">
                                    ...
                                    <h3 className="font-semibold text-gray-900 dark:text-white mt-1">Consommer responsable : Pourquoi acheter d'occasion ?</h3>
                                    <Link href="/articles/consommer-responsable" className="text-[#6ED47C] dark:text-[#6ED47C] text-sm font-medium flex items-center mt-2">
                                        LIRE L'ARTICLE →
                                    </Link>
                                </div>
                                ...
                                <div className="bg-white dark:bg-[#1C1929] rounded-lg p-4">
                                    ...
                                    <Link href="/articles/selection-mois" className="text-[#6ED47C] dark:text-[#6ED47C] text-sm font-medium flex items-center mt-2">
                                        LIRE L'ARTICLE →
                                    </Link>
                                </div>
                                ...
                                <div className="bg-white dark:bg-[#1C1929] rounded-lg p-4">
                                    <div className="text-xs text-gray-500 dark:text-gray-400">24/09/2024</div>
                                    <h3 className="font-semibold text-gray-900 dark:text-white mt-1">Soutenir l'économie locale en achetant d'occasion</h3>
                                    <Link href="/articles/economie-locale" className="text-[#6ED47C] dark:text-[#6ED47C] text-sm font-medium flex items-center mt-2">
                                        LIRE L'ARTICLE →
                                    </Link>
                                </div>
                                ...
                                <div className="bg-white dark:bg-[#1C1929] rounded-lg p-4">
                                    <div className="text-xs text-gray-500 dark:text-gray-400">24/09/2024</div>
                                    <h3 className="font-semibold text-gray-900 dark:text-white mt-1">Ressourceries et recycleries : Des tremplins vers l'emploi</h3>
                                    <Link href="/articles/tremplins-emploi" className="text-[#6ED47C] dark:text-[#6ED47C] text-sm font-medium flex items-center mt-2">
                                        LIRE L'ARTICLE →
                                    </Link>
                                </div>
                            </div>
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-12">
                        <div className="bg-[#E0E1FF] dark:bg-[#1C1929] rounded-3xl p-4 sm:p-8 lg:p-12">
                            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
                                <div className="text-white text-7xl sm:text-8xl">
                                    ⟳
                                </div>
                                <div className="flex-1 text-center md:text-left">
                                    ...
                                    <p className="text-gray-700 dark:text-gray-300 mt-4 max-w-2xl text-sm sm:text-base">
                                        Pivot rassemble l'ensemble de l'actualité de chaque ressourceries.<br className="hidden sm:block" />
