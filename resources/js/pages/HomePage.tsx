                            ...
                            <div className="w-full lg:w-3/4">
                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 lg:grid-cols-3 lg:gap-8 xl:grid-cols-4">
                                    ...
                                    <MinimalCard className="relative">
                                        ...
                                        <button type="button" className="absolute top-5 right-5 rounded-full bg-white p-1 shadow-sm dark:bg-gray-800">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <MinimalCard className="relative">
                                        ...
                                        <div className="px-4 pb-4">
                                            ...
                                            <MinimalCardTitle className="mt-0 px-0 text-base leading-tight">Ensemble de couverts</MinimalCardTitle>
                            ...
                            <div className="order-last grid grid-cols-1 gap-6 sm:grid-cols-2 lg:order-first lg:gap-8">
                                ...
                                <MinimalCard className="relative">
                                    ...
                                    <div className="px-4 pb-4">
                                        ...
                                        <div className="mb-1 font-semibold text-[#6ED47C] text-xs uppercase dark:text-[#6ED47C]">ART DE LA TABLE</div>
